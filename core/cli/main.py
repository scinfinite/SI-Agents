...
def build_parser() -> argparse.ArgumentParser:
    ...
    skills = sub.add_parser("skills", help="list, inspect, and compose portable Skills")
    skills.add_argument("--category")
    skills.add_argument("--status", choices=("experimental", "validated", "deprecated", "blocked"), default="validated")
    skills.add_argument("--search")
    skills.add_argument("--inspect")
    skills.add_argument("--compose", nargs="+")
    ...
    setup.add_argument("--install-opencode", action="store_true")
    setup.add_argument("--configure-opencode", action="store_true")
