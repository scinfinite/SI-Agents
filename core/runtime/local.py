...
class LocalHarnessAdapter:
    ...
    def __init__(self, capabilities: dict[str, Callable[[object], object]], *, harness_id: str = "local") -> None:
    ...
    def invoke(self, request: InvocationRequest) -> InvocationResponse:
        ...
        except Exception as exc:  # noqa: BLE001 - normalize arbitrary adapter-boundary failures
            return InvocationResponse(
                request.request_id,
                InvocationStatus.FAILED,
