"""Audit the checked-in SI persona corpus for deterministic parity invariants."""
...
def main() -> int:
    ...
    agents = catalog.all()
    if len(paths) != 300 or index["agent_count"] != 300 or index["source_division_count"] != 18 or len(agents) != 300:
    ...
    print("SI-AGENTS PERSONA PARITY PASS: 300 personas")
    return 0
